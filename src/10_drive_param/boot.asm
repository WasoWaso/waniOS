...
;関数の概要(メインプログラムです)
; 0. ドライブパラメータを取得して表示します、新しくget_drive_param関数を作成したのでCHSの情報
;    が知ることができるようになりました、param関数はブートプログラムに配置した構造体を引数として
;    渡すことでドライブ情報を返してくれます、そして得た値をitoa関数で文字列に変換してputs関数で
;    テレタイプ式文字出力をします.ソースコード中の144行目から148行目にitoa関数で変換したい場所
;    を"-"としていますが.s2から文字列の始まりとみなして.p4の終端に0を配置することで全体で見た
;    ときに一つの文字列と見ることができます.
