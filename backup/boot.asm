...
BOOT:
        ...
        %include "/home/m8ku/prog/src/modules/real/CeasarCodeEncrypt.asm"
...
;(関数の概要(ブートプログラムです))
; 0. 今回利用する'putc'関数と'macro'マクロをそれぞれ取り込みます
...
; 10. macroファイル中のcdeclへputc関数と表示したい文字をを渡して文字を表示します
